...
def main():
    ...
    p.add_argument('--root', required=True, help='ROOT_NEURON name or bodyId (e.g. DNge104)')
    ...
    # # If the root looks like an integer, treat it as a bodyId
    # try:
    #     bodyid = int(root)
    #     criteria = NC(bodyId=bodyid)
    # except Exception:
    #     criteria = NC(instance=root)
